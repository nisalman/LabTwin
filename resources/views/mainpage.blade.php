                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <div class="product-details-content position-relative">
                                    ...
                                    <div class="color-group d-flex align-items-center">
                                        <span class="list-heading bold">Calibration date: {{$instrument->calibration_date}}</span>
                                    </div>

                                    <div class="color-group d-flex align-items-center">
                                        <span class="list-heading bold">Inventory id : {{$instrument->inventory_number}}</span>
                                    </div>

                                    <div class="color-group d-flex align-items-center">
                                        <span class="list-heading bold">Digital resource:<a href="#"> {{$instrument->digital_resource}}</a></span>
                                    </div>
                                    <!-- End Color Group -->
                                    ...
                                    <!-- Add to Cart Button -->
                                    <button type="submit" data-toggle="modal" data-target="#createEventModal" class="button btn btn-fill">Take</button>
                                    <button type="submit" data-toggle="modal" data-target="#printBarCodeModal" class="button btn btn-fill">Print QR</button>
                                    <button type="submit" class="button btn btn-fill btn-danger">Remove</button>
