                        ...
                        <form action="#">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <!-- Form Group -->
                                    <div class="form-group mb-20">
                                        <label for="l_name" class="mb-2 font-14 bold black">Last Name</label>
                                        <input type="text" id="l_name" class="theme-input-style" placeholder="Last Name">
                                    </div>
                                    <!-- End Form Group -->
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group mb-20">
                                        ...
                                        <input type="text" id="u_name" class="theme-input-style" placeholder="User Name">
                                    </div>
                                    <!-- End Form Group -->
                                </div>
                            ...
                            <div class="d-flex align-items-center pt-4">
                                ...
                                <span class="font-12 d-block"><a href="login.blade.php" class="bold">Log In</a>,If you already have an account.</span>
                            </div>
                        </form>
                    </div>
                </div>
