                            ...
                            <div class="card mt-1">
                                ...
                                <div class="user-profile-nav d-flex justify-content-xl-between align-items-xl-center flex-column flex-xl-row">
                                    ...
                                    <div class="profile-info d-flex align-items-center">
                                        ...
                                        <div>
                                            <!-- Upload Photo -->
                                            <input class="file-input" name="file" type="file" id="file">
                                            <!-- End Upload Photo -->
                                        </div>
                                                    ...
                                                    <div class="form-group row align-items-center">
                                                        ...
                                                        <div class="col-9">
                                                            <input type="text" name="lname" id="edit-lname"
                                                                   class="form-control" value="{{$user->lname}}">
                                                        </div>
                                                    </div>
                                                    <!-- End Form Group -->
                                                    ...
                                                    <div class="form-group row align-items-center">
                                                        ...
                                                        <div class="col-9">
                                                            <input type="text" name="age" id="edit-age"
                                                                   class="form-control" value="{{$user->age}}">
                                                        </div>
                                                    </div>
                                                    <!-- End Form Group -->
                                        ...
                                        <div class="card mb-30">
                                            <div class="card-body p-30">
                                                <div class="about-myself mb-5">
                                                    ...
                                                    <textarea name="about" class="theme-input-style style--two">
                                                        {{$user->about}}
                                                    </textarea>
                                                </div>
                                                <!-- Change Password -->
