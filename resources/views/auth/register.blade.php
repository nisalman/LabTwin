<!DOCTYPE html>
                            ...
                            <div class="container">
                                ...
                                <div class="card justify-content-center auth-card">
                                    <div class="row justify-content-center">
                                        <div class="col-xl-10">
                                            <h4 class="mb-5 font-20">Welcome To LabTwin</h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="form-group mb-20">
                                                            <label for="f_name" class="mb-2 font-14 bold black"> Name</label>
                                                            <input type="text" id="f_name" name="name" class="theme-input-style" placeholder="First Name">
                                                        </div>
                                                        <!-- End Form Group -->
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="form-group mb-20">
                                                            ...
                                                            <input type="password" id="password" name="password" class="theme-input-style" placeholder="Password">
                                                        </div>
                                                        <!-- End Form Group -->
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <!-- Form Group -->
                                                        <div class="form-group mb-20">
                                                            <label for="r_password" class="mb-2 font-14 bold black">Retype Password</label>
                                                            <input type="password" id="r_password" name="password_confirmation" class="theme-input-style" placeholder="Password">
                                                        </div>
                                                        <!-- End Form Group -->
                                                    </div>
                                                </div>
                        ...
                        <footer class="footer style--two">
                            Dashmin © 2023 created by <a href="#"> LabTwin</a>
                        </footer>
                        <!-- End Footer -->
