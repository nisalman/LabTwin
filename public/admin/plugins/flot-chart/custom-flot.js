...
$(function() {
    ...
    $(function() {
        ...
        var plot = $.plot("#animated-graph", [getRandomData()], {
            series: {
    ...
    $(function() {
        ...
        $("#example-1").on("click", function(e) {
            ...
            $.plot(placeholder, data, {
                ...
                colors: ['#76B0FF', '#67CF94', '#0AD1DE', '#ecb403', '#e86a91'],
            });
        });
        ...
        $("#example-4").on("click", function(e) {
            ...
            $.plot(placeholder, data, {
                ...
                colors: ['#76B0FF', '#67CF94', '#0AD1DE', '#ecb403', '#64E572'],
                legend: {
                    show: false
                }
            });
